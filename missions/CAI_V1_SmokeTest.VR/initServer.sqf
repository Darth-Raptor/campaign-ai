...
[] spawn {
    ...
    private _redObjective = ["CAI_ModuleObjective", [0, 0, 0]] call _createLogic;
    ...
    private _blueObjective = ["CAI_ModuleObjective", [1200, 0, 0]] call _createLogic;
    ...
    private _commander = ["CAI_ModuleCommander", [0, -250, 0]] call _createLogic;
    ...
    private _redGroup = ["CAI_ModuleVirtualForces", [100, 0, 0]] call _createLogic;
    _redGroup setVariable ["CAI_groupId", "grp_red_001", true];
    _redGroup setVariable ["CAI_groupName", "REDFOR Test Platoon", true];
    ...
    _redGroup setVariable ["CAI_forceSize", "platoon", true];
    ...
    private _blueGroup = ["CAI_ModuleVirtualForces", [1200, 100, 0]] call _createLogic;
    ...
    private _debug = ["CAI_ModuleDebug", [0, -500, 0]] call _createLogic;
